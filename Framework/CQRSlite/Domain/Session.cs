...
namespace CQRSlite.Domain
{
    ...
    public class Session : ISession
    {
        ...
        public async Task<T> GetAsync<T>(Guid id, int? expectedVersion = null, CancellationToken cancellationToken = default(CancellationToken)) where T : AggregateRoot
        {
            if (IsTracked(id))
            {
        ...
        public async Task CommitAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            {
                tasks[i] = _repository.SaveAsync(descriptor.Aggregate, descriptor.Version, cancellationToken);
                i++;
            }
