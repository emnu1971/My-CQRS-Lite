...
namespace CQRSlite.Caching
{
    ...
    public class CacheRepository : IRepository
    {
        ...
        /// Purpose     : Save non-applied Aggregate Events to the EventStore
        /// </summary>
        /// <typeparam name="T">Aggregate type.</typeparam>
        /// <param name="aggregate">Aggregate</param>
        /// <param name="expectedVersion">Expected version of the Aggregate.</param>
            ...
            CancellationToken cancellationToken = default(CancellationToken)) where T : AggregateRoot
        {
            ...
            try
            {
                ...
                await _repository.SaveAsync(aggregate, expectedVersion, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
        ...
        /// <summary>
        /// Author      : Emmanuel Nuyttens
        /// Purpose     : Load events from the event store to rebuild current state of the Aggregate
        /// Date        : 05-2019
        /// </summary>
        /// <typeparam name="T">Aggregate type</typeparam>
